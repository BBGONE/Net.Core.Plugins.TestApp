...
namespace MyPlugin
{
    ...
    internal class MyPlugin1 : IPlugin
    {
        ...
        public MyPlugin1(string pluginName, CancellationToken cancellationToken, IPluginLoggerFactory loggerFactory)
        {
            ...
            this.logger = loggerFactory.CreateLogger(nameof(MyPlugin1));
        }
        ...
        public async Task<string> HandleAsync(string input)
        {
            ...
            string msg = $"plugin1: {sw.ElapsedMilliseconds}ms, Now: {DateTime.Now:HH:mm:ss.ff}"; ;
